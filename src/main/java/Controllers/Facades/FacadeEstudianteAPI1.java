...
import Controllers.Parsers.Responses.ResponseEstudianteAPI1;
import Controllers.Parsers.Responses.ResponseParser;
import Models.Estudiante;

public class FacadeEstudianteAPI1 {
    ...
    public FacadeEstudianteAPI1(String path) {
        this.apiRest = new APIEstudiantes(path);
        this.requestParser = new RequestEstudiante();
        this.responseParser = new ResponseEstudianteAPI1(this.apiRest);
    }
